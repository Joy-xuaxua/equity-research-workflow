...
**9.1 结论**：复述第一章决策三分法（内在价值判断 / 未来 1–3 个月市场交易方向 / 投资动作），并说明三者为何可能不同；回答"如果今天这是一笔现金，我会买入它吗？为什么？"

**9.2 反方论证 / 事前风险预演（Pre-mortem）（必做）**：换到反方立场，写出"一年后这笔投资失败了，最可能的 3 个原因"；对每条给出当前证据强度与监控信号。反方论证不是免责套话——至少一条必须是对本报告核心论点的直接攻击；若当前证据强度为中强/强，必须说明它如何改变第一章的市场交易方向、情景概率或投资动作。
...
**9.4 监控清单**：3–5 个持续跟踪指标（KPI/估值锚/证伪信号），各给关注阈值；至少包含一条上行证伪和一条下行证伪，方向不得混用。
